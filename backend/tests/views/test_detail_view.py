...
class TestDetailView:
    ...
    def test_patch_title_owner_returns_200(
        self, authenticated_client, test_model_picture
    ):
        url = self.get_url(test_model_picture.pk)
    ...
    def test_put_non_owner_returns_403(
        self, alt_authenticated_client, test_model_picture, test_model_image_file
    ):
        url = self.get_url(test_model_picture.pk)
